  ...
  const handleNavigationSetup = async (hotelSlug) => {
    ...
    try {
      const defaultNavItems = [
        ...
        { name: 'Rooms', slug: 'rooms', path: '/rooms', icon: 'door-closed', sort_order: 3, is_active: true },
        { name: 'Housekeeping', slug: 'housekeeping', path: `/staff/hotel/${hotelSlug}/housekeeping`, icon: 'house-gear', sort_order: 4, is_active: true },
        { name: 'Room Bookings', slug: 'room-bookings', path: `/staff/hotel/${hotelSlug}/room-bookings`, icon: 'calendar-check', sort_order: 5, is_active: true },
        { name: 'Staff', slug: 'staff', path: `/${hotelSlug}/staff`, icon: 'people', sort_order: 6, is_active: true },
        { name: 'Room Service', slug: 'room_service', path: `/room_service/${hotelSlug}`, icon: 'cart3', sort_order: 7, is_active: true },
        { name: 'Breakfast', slug: 'breakfast', path: `/breakfast/${hotelSlug}`, icon: 'cup-hot', sort_order: 8, is_active: true },
        { name: 'Menus', slug: 'menus', path: `/menus/${hotelSlug}`, icon: 'menu-button-wide', sort_order: 9, is_active: true },
        { name: 'Bookings', slug: 'bookings', path: `/staff/hotel/${hotelSlug}/bookings`, icon: 'calendar3', sort_order: 10, is_active: true },
        { name: 'Guests', slug: 'guests', path: `/${hotelSlug}/guests`, icon: 'person-check', sort_order: 11, is_active: true },
        { name: 'Attendance', slug: 'attendance', path: `/staff/hotel/${hotelSlug}/attendance`, icon: 'clock-history', sort_order: 12, is_active: true },
        { name: 'Settings', slug: 'settings', path: `/staff/${hotelSlug}/settings`, icon: 'gear', sort_order: 13, is_active: true },
      ];
